...
<head>
    ...
    <!-- jquery-ui.min css -->
    <link rel="stylesheet" href="{{asset('assets_home/css/jquery-ui.min.css')}}">
    <!-- meanmenu css -->
    ...
    <link href="{{asset('assets_home/css/video-js.css')}}" rel="stylesheet">
    <!-- style css -->
    <link rel="stylesheet" href="{{asset('assets_home/style.css')}}">
    <!-- responsive css -->
    <link rel="stylesheet" href="{{asset('assets_home/css/responsive.css')}}">
    <!-- modernizr css -->
    <script src="{{asset('assets_home/js/vendor/modernizr-2.8.3.min.js')}}"></script>
</head>
...
<body>
    ...
    <!-- preloader Start -->
    <div id="preloader">
        <div id="status"><img src="{{asset('assets_home/images/banner/loader.gif')}}" id="preloader_image" alt="loader">
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-6">
                        ...
                        <div class="rp_mobail_menu_main_wrapper visible-xs">
                            ...
                            <div id="sidebar">
                                <h1><a href="index.html#">Duwitku</a></h1>
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 hidden-xs hidden-sm">
                                            <div class="btc_slider_about_img" data-animation="animated bounceInDown">
												<img src="{{asset('assets_home/images/about/1.png')}}" alt="about_img">
											</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="slider-content">
                                            <ul>
                                                <li data-animation="animated bounceInDown" class="slider_social_icon1"><a href="index.html#"><i class="fa fa-facebook"></i></a></li>
                                                <li data-animation="animated bounceInDown" class="slider_social_icon2"><a href="index.html#"><i class="fa fa-twitter"></i></a></li>
                                                <li data-animation="animated bounceInDown" class="slider_social_icon3"><a href="index.html#"><i class="fa fa-send-o"></i></a></li>
                                                <li data-animation="animated bounceInDown" class="slider_social_icon4"><a href="index.html#"><i class="fa fa-bitcoin"></i></a></li>
                                                <li data-animation="animated bounceInDown" class="slider_social_icon5"><a href="index.html#"><i class="fa fa-envelope"></i></a></li>
                                            </ul>
                                            <h2 data-animation="animated bounceInLeft">DUWITKU - Lending & <br>Investment Platform</h2>
                                            <div class="buttons">
                                                <a href="index.html#" class="btn1" data-animation="animated bounceInUp">WHITEPAPER</a>
                                                <a href="index.html#" class="btn2" data-animation="animated bounceInUp">Buy Tokens Now!</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  hidden-xs hidden-sm">
                        ...
                        <div class="carousel-nevigation">
                            <a class="prev" href="index.html#carousel-example-generic" role="button" data-slide="prev">
                                <i class="fa fa-angle-left"></i>
                            </a>
                            <a class="next" href="index.html#carousel-example-generic" role="button" data-slide="next">
    ...
    <script src="{{asset('assets_home/js/vendor/jquery-3.2.1.min.js')}}"></script>
    <!-- tether js -->
    <script src="{{asset('assets_home/js/tether.min.js')}}"></script>
    <!-- bootstrap js -->
    ...
    <!-- easypiechart js -->
    <script src="{{asset('assets_home/js/jquery.easypiechart.min.js')}}"></script>
    <!-- particles js -->
    <!-- wow js -->
    <script src="{{asset('assets_home/js/wow.min.js')}}"></script>
    <!-- smooth-scroll js -->
    <script src="{{asset('assets_home/js/smooth-scroll.min.js')}}"></script>
    <!-- plugins js -->
    <script src="{{asset('assets_home/js/plugins.js')}}"></script>
    <!-- EChartJS JavaScript -->
    <script src="{{asset('assets_home/js/echarts-en.min.js')}}"></script>
    <script src="{{asset('assets_home/js/echarts-liquidfill.min.js')}}"></script>
    <script src="{{asset('assets_home/js/vc_round_chart.min.js')}}"></script>
    <script src="{{asset('assets_home/js/videojs-ie8.min.js')}}"></script>
    <script src="{{asset('assets_home/js/video.js')}}"></script>
    <script src="{{asset('assets_home/js/Youtube.min.js')}}"></script>
    <!-- main js -->
